...
import com.example.cps_lab.models.ScannerViewModel;
import com.example.cps_lab.style.StyledSnackBar;
...
public class ScannerFragment extends Fragment implements ScannerStatusFragmentDialog.onScannerStatusCancelListener {
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        ...
        filtersTitleGroupView.setVisibility(View.GONE);
        ...
        multiConnectTitleGroupView.setVisibility(View.GONE);
