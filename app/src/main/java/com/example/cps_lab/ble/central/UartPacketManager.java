package com.example.cps_lab.ble.central;
...
import com.example.cps_lab.ble.UartPacket;
import com.example.cps_lab.ble.UartPacketManagerBase;
import com.example.cps_lab.mqtt.MqttManager;
import com.example.cps_lab.mqtt.MqttSettings;
...
public class UartPacketManager extends UartPacketManagerBase {
    ...
    public void send(@NonNull BlePeripheralUart uartPeripheral, @NonNull String text, boolean wasReceivedFromMqtt) {
        ...
        UartPacketManagerBase.Listener listener = mWeakListener.get();
